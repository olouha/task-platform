...
import api, { adjustmentProjectApi, adjustmentCalcApi, fileParserApi, adjustmentPricesApi, adjustmentTemplateApi } from '../services/api';
...
export default function Adjustment() {
  ...
  const handleFileSelect = async (info: any) => {
    ...
    try {
      ...
      const response = await fetch(`${api.config.apiUrl}/api/file-parser/upload`, {
        method: 'POST',
        body: formData,
      });
  ...
  const handleBatchFetchPrices = async () => {
    ...
    try {
      ...
      const res = await fetch(`${api.config.apiUrl}/api/adjustments/prices/batch-get`, {
        method: 'POST',
