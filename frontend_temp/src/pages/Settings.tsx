...
export default function Settings() {
  ...
  const fetchCredentialsStatus = async () => {
    try {
      const response = await fetch(`${api.config.apiUrl}/api/yantai-prices/credentials`)
  ...
  const handleUpdateCredentials = async (values: any) => {
    setUpdating(true)
    try {
      const response = await fetch(`${api.config.apiUrl}/api/yantai-prices/update-credentials`, {
        method: 'POST',
