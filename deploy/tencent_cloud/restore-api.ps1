# 从 Base64 解码并创建 api.ts 文件
$base64Content = "Ly8gQVBJIOiB0aXTmuK/r\nLiODkee6u+t5\nLy8g6Ieq5o6l5ZG95\nCmltcG9ydCBtZXRh\nIFR5cGUgZGVmaW5pdGlv\nbnMgYXJlIGluIHRoZ\nSBzYW1lIGZpbGUuCgov\nL+Wksei0p+S7o+ihqOin\nhue2reOCkuWFseS\nzzKzvvIwKLy8g5p\nlIH5ZGY5Yqh5by6\n5biC6KeB6ZQgQFJJ\nVV05Ly8g6L+U6Kev\nIEFSRz0gJ1wvYXBp\nJyDnmoTmraXlv5L\nnnIrog73lpJ/n\n\nmoTnlYfmiY3mnIn\n\nooajpZBl\nLy8g6\nK6\n57O75\nLq\nL\nTC\nWX\n"
...
# 确保目录存在
New-Item -ItemType Directory -Path "C:\taskplatform\frontend\src\services" -Force | Out-Null

# 写入文件
[System.IO.File]::WriteAllText('C:\taskplatform\frontend\src\services\api.ts', $content, $utf8NoBom)

Write-Host "文件创建成功！"

# 验证文件
Get-Item 'C:\taskplatform\frontend\src\services\api.ts' | Select-Object Name, Length
